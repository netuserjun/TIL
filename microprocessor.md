...
<br>
역시 각 인터럽트마다 enable, disable을 할 수 있는데, EIMSK라는 레지스터를 이용해서 INT0부터 INT7까지를 지정할 수 있다. <br>
...
전압 0,5만 잇는데 더 늘리기 가능?
심전도 측정과 전송과정 : <br>
블루투스 등 무선 신호를 어디서 어떤식으로 바꿔주는가
다른 무선 신호 잡음이 영향을 끼쳐서 오작동 나는 경우는 없나
